...
import DefaultDocsLayout from 'layouts/docs/DefaultDocsLayout';
...
function MyApp({ Component, pageProps }) {
  ...
  const Layout = Component.Layout || (router.pathname.includes('dashboard') ? (router.pathname.includes('instructor') || router.pathname.includes('student') ? DefaultMarketingLayout : DefaultDashboardLayout) : (router.pathname.includes('docs') ? DefaultDocsLayout : DefaultMarketingLayout))
